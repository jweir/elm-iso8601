...
testParsing =
    ...
    describe "Parsing"
        ...
        , assert "2006-11" 2006 11 1 0 0 0 0 0
        , assert "2015-03-02" 2015 3 2 0 0 0 0 0
        , assert "2015-03-02T15" 2015 3 2 15 0 0 0 0
        , assert "2015-03-02T15:16" 2015 3 2 15 16 0 0 0
        , assert "2015-03-02T15:16:17" 2015 3 2 15 16 17 0 0
        , assert "2006-01-02T15:04:05+00:00" 2006 1 2 15 4 5 0 0
        , assert "2006-01-02T15:04:05+05:30" 2006 1 2 15 4 5 0 (60 * 5 + 30)
        , assert "2006-01-02T15:04:05+0530" 2006 1 2 15 4 5 0 (60 * 5 + 30)
        , assert "2006-01-02T15:04:05-0700" 2006 1 2 15 4 5 0 (60 * -7)
        , assert "2006-01-02T15:04:05-1200" 2006 1 2 15 4 5 0 (60 * -12)
        , assert "1066-12-03T10:01:59+00:00" 1066 12 3 10 1 59 0 0

        -- resoltion greater than milliseconds is rounded
        , assert "2015-03-02T15:16:17.0009" 2015 3 2 15 16 17 1 0
        , assert "2015-03-02T15:16:17.00049999" 2015 3 2 15 16 17 0 0
        , assert "1066-12-03T10:01:59.022+00:00" 1066 12 3 10 1 59 22 0
        , assert "1066-12-03T10:01:59.5+00:00" 1066 12 3 10 1 59 500 0
...
fromUnixTest =
    ...
    in
    describe "fromTime"
        [ assert 0 1970 1 1 0 0 0 0 0
        , assert 1 1970 1 1 0 0 0 1 0
        , assert 3661123 1970 1 1 1 1 1 123 0
        , assert 86400000 1970 1 2 0 0 0 0 0
        , assert 1456707723000 2016 2 29 1 2 3 0 0
        , assert -1 1969 12 31 23 59 59 999 0
        , assert -2000 1969 12 31 23 59 58 0 0
        , assert -1456707723000 1923 11 3 22 57 57 0 0
        , assert -28497657538000 1066 12 12 0 1 2 0 0
        , assert 1451635200000 2016 1 1 8 0 0 0 0
        , assert 2493072000001 2049 1 1 0 0 0 1 0
        , assert 500 1970 1 1 0 0 0 500 0
        ]
