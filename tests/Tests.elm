...
toUnixTest =
  ...
  in
    suite
      ...
      , assert "2016-04-01T17:11:43Z" 1459530703000
      , assert "1969-12-01T00:00:00Z" -2678400000
      , assert "1960-02-01T00:00:00Z" -312940800000
      , assert "1969-11-30T00:00:00Z" -2764800000
...
fromUnixTest =
  suite
    ...
    , testFromUnix 1459530703000 2016 4 1 17 11 43 0 ( 0, 0 )
    , testFromUnix -312940800000 1960 2 1 0 0 0 0 (0,0)
    , testFromUnix (-312940800000 - 1) 1960 1 31 23 59 59 999 (0,0)
    , testFromUnix -312940800001 1960 1 31 23 59 59 999 (0,0)
